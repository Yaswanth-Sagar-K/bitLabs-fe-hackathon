            ...
            <div className="col-lg-12 col-md-12">
              ...
              <div className="box-notifications">
                {jobAlerts.length > 0 ? (
                  <ul>
                    {jobAlerts.map(alert => (
                      <li key={alert.alertsId}  className='inner' style={{ width: '100%', padding: '2%', borderRadius: '10px', height: '100px', position: 'relative', backgroundColor: alert.seen ? '#E5EAF5' : '#FFFFFF' }}>
                          <button
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', position: 'relative', height: '50px' }}>
                          ...
                          <h4 style={{ marginLeft: '25px' }}>
                              ...
                              >
                                Your application status has been marked as &nbsp;{alert.status === 'New' ? 'Applied Job' : alert.status}
  {' '} by {alert.companyName} for {' '} {alert.jobTitle} {' '} role {' '}.
                                <br /> 
                          ...
                          <button
                              style={{ all: 'unset', marginLeft: '30px', cursor: 'pointer', color: '#fd7e14', fontWeight: 'bold' }}
                              onClick={(e) => {
                                e.stopPropagation();
                                e.preventDefault();
